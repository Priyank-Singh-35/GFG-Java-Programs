...
class Solution
{
    // Function to solve the Josephus problem and find the position of the last remaining person
    public int josephus(int n, int k)
    {
        // Base case: If there is only one person, they are the last remaining person
        if (n == 1) {
            return 1;
        } else {
            // Recursive case: Find the position of the last remaining person
            // after eliminating one person in each step
